...
public class StringConstants {
    ...
    public static final String MAIN_GREETING = """
            ...
            Если же вы являетесь волонтером нашего питомника, то введите команду /volunteer в ответном сообщении и следуйте дальнейшим указаниям.""";
    ...
    public static final String SUCCESS_ADD_VOLUNTEER = "Вы были успешно добавлены в список волонтеров нашего приюта. При желании в ответном сообщении введите" +
            " свое имя, например \"Alexey\" (без кавычек и латинскими буквами), чтобы я знал как можно к вам обращаться";
    ...
    public static String msgToVol(String userName) {
        return String.format("Пользователю с ником %s нужна консультация. Прошу вас связаться с ним в ближайшее время. После завершения консультации с пользователем прошу вас" +
                " отправить мне команду /finish. Иначе я не смогу отпустить вас", userName) ;
    }
